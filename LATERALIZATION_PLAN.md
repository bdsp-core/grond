...
This document summarizes findings from analyzing the [IIIC-Frequency-Analysis-2](https://github.com/bdsp-core/IIIC-Frequency-Analysis-2) repository and outlines a plan to extend it with continuous per-channel RDA scores and a laterality index.
