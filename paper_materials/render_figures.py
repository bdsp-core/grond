...
Reads figure_*_examples_data.json and produces figures/fig{6,7,8,9}_*_characterization.png at 300 DPI.
"""
...
def render_subtype(subtype, cases, is_pd):
    ...
    # Map subtype -> figure number per the manuscript: lpd=fig6, gpd=fig7, lrda=fig8, grda=fig9.
    # (Fig 5 is now the IRR-comparison bar plot generated by build_fig_irr_bars.py.)
    fig_num = {'lpd': 6, 'gpd': 7, 'lrda': 8, 'grda': 9}[subtype]
    figures_dir = os.path.join(SCRIPT_DIR, 'manuscript', 'figures')
